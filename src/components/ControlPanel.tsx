      ...
      <div className="p-6 flex-1 space-y-8">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3.5">
            ...
            <div className="flex items-center justify-between p-3 bg-slate-950/60 border border-slate-850 rounded-lg">
              <div>
                <span className="block text-xs font-semibold text-slate-200">Enable Developer Mode</span>
                <span className="text-[10px] text-slate-400">Expose legacy code exporter (HTML/SCSS)</span>
              </div>
              <button 
                onClick={() => updateField('devMode', !config.devMode)}
                className="text-slate-400 hover:text-white transition-colors cursor-pointer"
              >
                {config.devMode ? (
