...
export const DEFAULT_ERROR_403_CONFIG: ErrorPageConfig = {
  ...
  safeDetails: 'نطاق اتصال جهازك الحالي غير مدرج في قائمة الأجهزة المسموح لها بالوصول الآمن، أو أن حسابك يفتقر إلى الصلاحيات الكافية لاستعراض هذه البوابة الحساسة.',
